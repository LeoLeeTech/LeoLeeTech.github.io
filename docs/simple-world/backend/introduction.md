...
Once you're set up, read the rest of the backend specification: [Endpoints](/docs/simple-world/backend/endpoints/), [API response format](/docs/simple-world/backend/api-response-format/), and [Error handling](/docs/simple-world/backend/error-handling/). You can also start from our [starter kit](https://github.com/gothinkster/realworld-starter-kit).
