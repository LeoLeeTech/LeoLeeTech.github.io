...
> See how _the exact same_ Medium.com clone is built using different [frontends](https://codebase.show/projects/realworld?category=frontend) and [backends](https://codebase.show/projects/realworld?category=backend). Yes, you can mix and match them, because **they all adhere to the same [API spec](/docs/simple-world/backend/introduction)** 😮😎
...
- Every tutorial is built against the same [API spec](/docs/simple-world/backend/introduction) to ensure modularity of every frontend & backend
...
- Interested in creating a new RealWorld stack? View our [backend API spec](/docs/simple-world/backend/introduction)
